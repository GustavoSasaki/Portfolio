...
function LinkMobile({ children, onClick }: { children: JSX.Element[] | JSX.Element, onClick: () => void }) {
    return (
        <button onClick={onClick} className='capitalize text-2xl text-secondary font-semibold'>{children}</button>
    )
}
