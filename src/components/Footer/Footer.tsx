    ...
    return (
        <footer className=" h-min-6 bg-primary-light pt-4 pb-3">
            <div className="flex justify-between items-center gap-1 gu-container">
                <a href="." className="h-[70px] w-[70px] bg-accent-400 rounded-full group md:hidden mb-2 flex justify-center items-center" title="Home">
                    <BiSolidUpArrow className='h-[40px] w-[40px]  text-secondary
