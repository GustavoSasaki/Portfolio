...
export function Hero({variant}: Variants) {
    return (
                    ...
                    <div id="hero-title">
                        ...
                        <div className="text-4xl sm:text-5xl font-bold">
                            ...
                            <Underline variant="big">
                                <p>{variant === 'main' ? 'Web Developer' : 'Software Engineer'}</p>
                            </Underline>
                        </div>
                    </div>
...
export const description = "I am a developer interested in creating cool web apps 🛠️, learning new technologies 📚 and running 🏃."
