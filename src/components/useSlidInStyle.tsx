...
export function useSlidInStyle({wasEverVisible, preStyle}:{wasEverVisible: boolean, preStyle:string}){
...
function GetSlideInClass(state: "pre" | "active" | "locked" | undefined,preStyle:string) {
...
export function useSlidInState({wasEverVisible}:{wasEverVisible: boolean}){

    const scrollDirection = useScrollDirection()
    const [animationState, setAnimationState] = useState<"pre" | "active" | "locked">()
